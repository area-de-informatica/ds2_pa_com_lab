...
var RespuestasController = function () {
    var _classDecorators = [(0, common_1.Controller)('respuestas')];
    ...
    var RespuestasController = _classThis = /** @class */ (function () {
        function RespuestasController_1(respuestasService) {
            this.respuestasService = (__runInitializers(this, _instanceExtraInitializers), respuestasService);
        }
        RespuestasController_1.prototype.create = function (createRespuestaDto) {
            return this.respuestasService.create(createRespuestaDto);
        };
        RespuestasController_1.prototype.findAll = function () {
            return this.respuestasService.findAll();
        };
        RespuestasController_1.prototype.findOne = function (id) {
            return this.respuestasService.findOne(id);
        };
        RespuestasController_1.prototype.update = function (id, updateRespuestaDto) {
            return this.respuestasService.update(id, updateRespuestaDto);
        };
        RespuestasController_1.prototype.remove = function (id) {
