...
var respuestas_service_1 = require("./respuestas.service");
var respuestas_controller_1 = require("./respuestas.controller");
var mongoose_1 = require("@nestjs/mongoose");
var respuestas_schema_1 = require("./schemas/respuestas.schema");
var RespuestasModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forFeature([{ name: 'Respuesta', schema: respuestas_schema_1.RespuestaSchema }])
            ],
