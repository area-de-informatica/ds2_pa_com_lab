...
exports.ContenidoSchema = exports.Contenidos = void 0;
...
var Contenidos = function () {
    ...
    var Contenidos = _classThis = /** @class */ (function (_super) {
        __extends(Contenidos_1, _super);
        function Contenidos_1() {
            ...
            _this.Unidades = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _Unidades_initializers, void 0));
            __runInitializers(_this, _Unidades_extraInitializers);
            return _this;
        }
        return Contenidos_1;
    }(_classSuper));
    __setFunctionName(_classThis, "Contenidos");
    (function () {
        var _a;
        ...
        Contenidos = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Contenidos = _classThis;
}();
exports.Contenidos = Contenidos;
exports.ContenidoSchema = mongoose_1.SchemaFactory.createForClass(Contenidos);
